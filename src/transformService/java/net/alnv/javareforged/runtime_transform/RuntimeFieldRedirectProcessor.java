...
public final class RuntimeFieldRedirectProcessor implements ClassProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(RuntimeFieldRedirectProcessor.class);
    private static final boolean LOG_REWRITES = Boolean.getBoolean("javareforged.runtimeRedirectLog");
    private static final boolean BROAD_COMPATIBILITY_SCAN = Boolean.getBoolean("javareforged.runtimeRedirectBroad");
    private static final String MINECRAFT_ACCESS_OWNER = "net/jr/client/runtime/bridge/MinecraftClientAccess";
    private static final String GUI_SCREEN_ACCESS_OWNER = "net/jr/client/runtime/bridge/GuiScreenAccess";
    private static final String GAME_RENDERER_ACCESS_OWNER = "net/jr/client/runtime/bridge/GameRendererAccess";
    ...
    private static final Map<FieldKey, FieldRedirect> PUTFIELD_REDIRECTS = Map.ofEntries(
        Map.entry(
            new FieldKey(MINECRAFT_OWNER, "gameMode", "Lnet/minecraft/client/multiplayer/MultiPlayerGameMode;"),
            new FieldRedirect(MINECRAFT_ACCESS_OWNER, "setGameMode")
        ),
        Map.entry(
            new FieldKey(MINECRAFT_OWNER, "level", "Lnet/minecraft/client/multiplayer/ClientLevel;"),
            new FieldRedirect(MINECRAFT_ACCESS_OWNER, "setLevel")
        ),
        Map.entry(
            new FieldKey(MINECRAFT_OWNER, "player", "Lnet/minecraft/client/player/LocalPlayer;"),
            new FieldRedirect(MINECRAFT_ACCESS_OWNER, "setPlayer")
        ),
        Map.entry(
            new FieldKey(MINECRAFT_OWNER, "crosshairPickEntity", "Lnet/minecraft/world/entity/Entity;"),
            new FieldRedirect(MINECRAFT_ACCESS_OWNER, "setCrosshairPickEntity")
        ),
        Map.entry(
            new FieldKey(MINECRAFT_OWNER, "hitResult", "Lnet/minecraft/world/phys/HitResult;"),
            new FieldRedirect(MINECRAFT_ACCESS_OWNER, "setHitResult")
        ),
        Map.entry(
            new FieldKey(GUI_OWNER, "screen", "Lnet/minecraft/client/gui/screens/Screen;"),
            new FieldRedirect(GUI_SCREEN_ACCESS_OWNER, "setScreen")
        )
    );
    ...
    private static final Map<MethodKey, MethodRedirect> METHOD_REDIRECTS = Map.ofEntries(
        Map.entry(
            ...
            new MethodRedirect(GAME_RENDERER_ACCESS_OWNER, "mainCamera", "(L" + GAME_RENDERER_OWNER + ";)Lnet/minecraft/client/Camera;")
        ),
        Map.entry(
            new MethodKey(MINECRAFT_OWNER, "getCameraEntity", "()Lnet/minecraft/world/entity/Entity;"),
            new MethodRedirect(MINECRAFT_ACCESS_OWNER, "cameraEntity", "(L" + MINECRAFT_OWNER + ";)Lnet/minecraft/world/entity/Entity;")
        ),
        Map.entry(
            new MethodKey(MINECRAFT_OWNER, "setCameraEntity", "(Lnet/minecraft/world/entity/Entity;)V"),
            new MethodRedirect(MINECRAFT_ACCESS_OWNER, "setCameraEntity", "(L" + MINECRAFT_OWNER + ";Lnet/minecraft/world/entity/Entity;)V")
        )
    );
    ...
    public ComputeFlags processClass(TransformationContext context) {
        ...
        if (redirectedReads == 0 && redirectedWrites == 0 && redirectedCalls == 0) {
            return ComputeFlags.NO_REWRITE;
        }
