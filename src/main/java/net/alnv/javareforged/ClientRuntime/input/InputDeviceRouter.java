...
import net.alnv.javareforged.client.input.gamepad.GamepadDigitalInput;
import net.alnv.javareforged.client.input.gamepad.GamepadIdentity;
import net.alnv.javareforged.client.input.sdl.SdlGamepad;
import net.alnv.javareforged.client.input.simulation.InputSimulation;
