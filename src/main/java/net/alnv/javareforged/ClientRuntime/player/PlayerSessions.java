package net.alnv.javareforged.ClientRuntime.player;

import net.alnv.javareforged.mixin.SSM.MinecraftActionSSAccessor;
import net.alnv.javareforged.client.input.InputApi;
import net.alnv.javareforged.ClientRuntime.runtime.ClientBoundary;
import net.alnv.javareforged.ClientRuntime.runtime.LocalPlayerChunkPressure;
...
import net.alnv.javareforged.ClientRuntime.runtime.WorldEngineStateScope;
    ...
    private void tickSecondarySession(Minecraft minecraft, LocalPlayers players, PlayerSession session) {
        ...
        ClientBoundary.runForSlot(slot, () -> {
            ...
            try (WorldEngineStateScope ignoredEngines = WorldEngineStateScope.bind(minecraft, slot)) {
                TerrainDebug.recordRawStateCheck("secondaryTick.begin", slot.id(), minecraft);
                ...
                TerrainDebug.recordRawStateCheck("secondaryTick.end", slot.id(), minecraft);
            }
        });
    }

    private void handleSecondaryKeybinds(Minecraft minecraft, PlayerSlot slot) {
        if (minecraft.getOverlay() != null || slot.screenState().screen() != null) {
            return;
        }
