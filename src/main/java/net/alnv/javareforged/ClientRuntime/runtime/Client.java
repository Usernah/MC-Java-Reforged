...
public final class Client {
    ...
    public static Screen screen(Minecraft minecraft) {
        LocalClient client = currentOrNull();
        return client != null ? client.screen() : minecraft.screen;
    }
    ...
    public static Entity cameraEntity(Minecraft minecraft) {
        LocalClient client = currentOrNull();
        if (client == null) {
            return liveEntityOrNull(minecraft.cameraEntity);
        }
    ...
    public static boolean noRender(Minecraft minecraft) {
        LocalClient client = currentOrNull();
        return client != null ? client.render().noRender() : minecraft.noRender;
    }
    ...
    public static void setScreen(int clientId, @Nullable Screen screen) {
        ...
        ClientBoundary.runForSlot(target.rawSlot(), () -> Minecraft.getInstance().setScreen(screen));
    }
    ...
    private static LocalClient client(int clientId) {
