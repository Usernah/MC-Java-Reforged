package net.alnv.javareforged.ClientRuntime.audio;
...
import net.alnv.javareforged.mixin.SSM.SoundEngineActiveSoundsAccessor;
import net.alnv.javareforged.mixin.SSM.SoundManagerEngineAccessor;
...
public final class SlotSoundRouting {
    ...
    private static boolean matches(
        ...
        return soundName == null || sound.getLocation().equals(soundName);
    }
