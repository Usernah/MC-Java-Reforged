...
public final class TerrainGraphArea extends ViewArea {
    private final SharedTerrainStore store;
    private final LocalTerrainView view;
    ...
    public boolean repositionCamera(SectionPos nextCameraSectionPos) {
        ...
        LocalTerrainView.Update update = this.view.update(
            this.store,
            this.level,
    ...
    public boolean matches(SharedTerrainStore store, ClientLevel level, int viewDistance, int slotId) {
