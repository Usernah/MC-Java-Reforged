 ...
 */
public final class LocalClientAcces {
    public static final int MAX_CLIENTS = LocalClientSlots.MAX_SLOTS;

    private LocalClientAcces() {
    }
    ...
    public static int joinNext(Minecraft minecraft) {
        return ClientRuntime.INSTANCE.joinNextClient(minecraft);
    }
    ...
    public static ChatState chat() {
        return current().chat();
    }

    public static ChatState chat(int clientId) {
        return client(clientId).chat();
    }

    public static ToastState toasts() {
        return current().toasts();
    }

    public static ToastState toasts(int clientId) {
        return client(clientId).toasts();
    }
    ...
    public static void setScreen(int clientId, @Nullable Screen screen) {
        ...
        LocalClientExecution.runForSlot(target.slot(), () -> Minecraft.getInstance().gui.setScreen(screen));
    }
    ...
    public static void bindScreen(@Nullable Screen screen) {
        ...
        LocalScreenManager.onSlotScreenChanged(Minecraft.getInstance(), active.slotId(), screen);
    }
    ...
    public static void bindScreen(Gui gui, @Nullable Screen screen) {
        ...
        if (active == null) {
            ...
            if (minecraft != null) {
                LocalScreenManager.onSlotScreenChanged(minecraft, primary.slotId(), screen);
            }
            return;
        }
        bindScreen(screen);
    ...
    public static void clearWorldBinding() {
        current().slot().clearWorldBinding();
    }

    public static void clearWorldBinding(int clientId) {
        client(clientId).slot().clearWorldBinding();
    }
    ...
    static LocalClient client(int clientId) {
        return new LocalClient(ClientRuntime.INSTANCE.slots().slot(clientId));
    }
