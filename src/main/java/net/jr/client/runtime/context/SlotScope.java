...
public final class SlotScope {
    ...
    public static int requireId() {
        ...
        if (slotId == null) {
            throw new IllegalStateException("No active local client slot is bound to this execution path");
        }
        requireValid(slotId);
        return slotId;
    }
    ...
    public static void bootstrapPrimary() {
        ...
        if (current != null) {
            throw new IllegalStateException("Primary slot bootstrap was already installed: " + current);
        }
