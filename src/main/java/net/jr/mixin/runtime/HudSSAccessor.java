...
@Mixin(Hud.class)
public interface HudSSAccessor {
    ...
    @Accessor("lastBubblePopSoundPlayed") int splitTest$getLastBubblePopSoundPlayed();
    @Accessor("lastBubblePopSoundPlayed") void splitTest$setLastBubblePopSoundPlayed(int value);
