...
public abstract class MixinMusicManager implements MusicManagerBridge {
    ...
    @Overwrite
    public void tick() {
        MusicTransitionManager.tickMusicContinuityProtection();
        ...
        boolean protectDuringLoad = this.loadingMode
            || MusicTransitionManager.shouldProtectWorldLoadAudio()
            || MusicTransitionManager.shouldProtectForcedSoundStop()
            || MusicTransitionManager.shouldProtectRespawnMusicStop();
        boolean protectPassiveStop = protectDuringLoad || MusicTransitionManager.shouldProtectMusicContinuity();
